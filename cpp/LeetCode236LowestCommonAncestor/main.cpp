//Depth first search solution. This is really the solution I submitted for binary search tree (I know, a ridiculous solution for that problem), but with slight modification to compare pointer values instead of integer node values. This is due to the fact that the tree may contain duplicate integer values.
// Accepted as beating 64.85% of all cpp submissions. 
#include<iostream>
#include<queue>
#include<vector>
#include<sstream>
...
int main() {
    ...
    int nullVal = -2000;
    int numArray[] = {37,-34,-48,nullVal,-100,-100,48,nullVal,nullVal,nullVal,nullVal,-54,nullVal,-71,-22,nullVal,nullVal,nullVal,8}, 
        pValsArray[] = {2, 2},
        qValsArray[] = {8, 4};
